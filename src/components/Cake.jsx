    ...
    {candlesBlownOut && (
      ...
      >
        ...
        <Link to='/present' className="flex justify-center items-center">
          <p className="absolute top-[30rem] xs:top-[26rem] s:top-[30rem] px-7 py-3 bg-customBlue text-white rounded-full hover:bg-blue-600 font-medium text-base text-center ">
            Next
          </p>
        </Link>
      </motion.div>
